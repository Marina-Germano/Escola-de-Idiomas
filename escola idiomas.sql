...
CREATE TABLE turma(
   ...
   -- tipo VARCHAR(200) NOT NULL, pra q eu criei isso?
	ididioma INT NOT NULL,
...
CREATE TABLE calendario_aula(
    ...
    idprofessor INT NOT NULL,
    idturma INT NOT NULL, -- turma de alunos, n sei se vai ficar assim
    idmaterial INT NOT NULL, -- materia da aula(ingles 1, espanhol 2...) 
    sala VARCHAR(100), 
    observacoes VARCHAR(300),
    status_aula ENUM("Agendada", "Cancelada", "Reagendada"), -- verificar se esse campo vai ficar aqui, verificar necessidade
    link_reuniao VARCHAR(255),
	aula_extra BOOLEAN DEFAULT FALSE,

    -- recorrencia
    recorrente BOOLEAN DEFAULT FALSE, -- vai ficar aqui ou mudar para outra tabela
