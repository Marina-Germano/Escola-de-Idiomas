...
// Depois (sem hash - compara com o texto puro do banco)
   ...
   if ($user) {
      ...
      elseif ($user['papel'] === 'aluno') {
         header('location: /conexus_sistema/app/views/aluno/home.php');
         exit;
      }
      elseif ($user['papel'] === 'professor') {
         header('location: /conexus_sistema/app/views/professor/home.php');
         exit;
      }
      elseif ($user['papel'] === 'funcionario') {
         header('Location: /conexus_sistema/app/views/funcionario/home.php');
      }
      else {
