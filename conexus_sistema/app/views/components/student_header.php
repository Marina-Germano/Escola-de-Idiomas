...
<header class="header">
   <section class="flex">
      <a href="/escola-de-idiomas/conexus_sistema/app/controllers/homeController.php" class="logo"> <img src="/escola-de-idiomas/conexus_sistema/public/img/conexus_sem_fundo.png" alt=""> Conexus </a>
      ...
      <div class="profile">
         ...
         if ($idusuario !== null) {
            ...
            $select_profile->execute([$idusuario]);
         ?>
               <img src="/escola-de-idiomas/conexus_sistema/public/img/public/img/pic-1.jpg<?= $fetch_profile['foto']; ?>" alt="">
...
<div class="side-bar">   
      <nav class="navbar">
         ...
         <a href="/escola-de-idiomas/conexus_sistema/app/views/components/user_logout.php" onclick="return confirm('logout from this website?');"><i class="fas fa-right-from-bracket"></i><span>Sair</span></a>
      </nav>
</div>
