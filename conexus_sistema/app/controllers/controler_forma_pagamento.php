    ...
    switch ($acao) {
        case 'cadastrar':
            if (!temPermissao()) {
                ...
                echo "Acesso negado. Apenas administradores podem cadastrar formas de pagamento.";
                exit;
            }
        ...
        case 'alterar':
            if (!temPermissao()) {
                http_response_code(403);
                echo "Acesso negado. Apenas administradores podem alterar formas de pagamento.";
                exit;
            }
        ...
        //case 'excluir':
           // if (!temPermissao()) {
               // http_response_code(403);
               // echo "Acesso negado. Apenas administradores podem excluir formas de pagamento.";
               // exit;
          //  }
        ...
        case 'listarId':
            ...
            break; //ver o que mais precisa ser listado para o relatorio
