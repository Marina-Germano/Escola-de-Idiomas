    ...
    switch ($acao) {
        case 'cadastrar':
            if (!temPermissao()) {
                ...
                echo "Apenas administradores e funcionários podem cadastrar idiomas.";
                exit;
            }
        ...
        case 'alterar':
            if (!temPermissao()) {
                http_response_code(403);
                echo "Apenas administradores e funcionários podem alterar idiomas.";
                exit;
            }
        ...
        case 'excluir':
            if (!temPermissao()) {
                http_response_code(403);
                echo "Apenas administradores e funcionários podem excluir idiomas.";
                exit;
            }
